...
const int button5Pin = 2;
const int button6Pin = 1;
const int button7Pin = 0;
const int button8Pin = A1;
const int button9Pin = A2;
const int button10Pin = A3;
const int button11Pin = A4;
const int button12Pin = A5;

const uint16_t
    grNotes[] =
    {
        NOTE_C3,       //corresponds to button 1
        NOTE_CS3,      // this is button 2
        NOTE_D3,       // this is button 3
        NOTE_DS3,      // this is button 4
        NOTE_E3,       // this is button 5
        NOTE_F3,       // this is button 6
        NOTE_FS3,      // this is button 7
        NOTE_G3,       // this is button 8
        NOTE_GS3,      // this is button 9
        NOTE_A3,       // this is button 10
        NOTE_AS3,      // this is button 11
        NOTE_B3,        // this is button 12
    };
